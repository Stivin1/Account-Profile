...
namespace OpenSourceEntitys.Migrations
{
    ...
    partial class EntitySourceContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenSourceEntitys.Models.EntityConfiguration.EntitySystem.Entitys.LoggingInformation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            Name = "Попытка входа пользователя"
                        },
                        new
                        {
                            id = 2,
                        ...
                        {
                            id = 3,
                            Name = "Получение данных страницы профиля"
                        },
                        new
                        {
                            id = 4,
                            Name = "Получение данных страницы пользователей"
                        },
                        new
                        {
                            id = 5,
                            Name = "Получение данных страницы изменения профиля"
                        },
                        new
                        {
                            id = 6,
                            Name = "Получение данных страницы изменения пользователя"
                        },
                        new
                        {
                            id = 7,
                            Name = "Получение данных страницы изменить пароль"
                        },
                        new
                        {
                            id = 8,
                            Name = "Получение данных страницы списка групп"
                        },
                        new
                        {
                            id = 9,
                            Name = "Получение данных страницы добавления группы"
                        },
                        new
                        {
                            id = 10,
                            Name = "Получение данных страницы добавления группы пользователю"
                        },
                        new
                        {
                            id = 11,
                            Name = "Получение данных страницы добавления роли"
                        },
                        new
                        {
                            id = 12,
                            Name = "Получение данных страницы добавления роли пользователю"
                        },
                        new
                        {
                            id = 13,
                            Name = "Получение данных страницы мои документы"
                        },
                        new
                        {
                            id = 14,
                            Name = "Получение данных страницы корзины документов"
                        },
                        new
                        {
                            id = 15,
                            Name = "Получение данных страницы почты"
                        },
                        new
                        {
                            id = 16,
                            Name = "Получение данных страницы отправки"
                        },
                        new
                        {
                            id = 17,
                            Name = "Получение данных страницы удаленных сообщений"
                        },
                        new
                        {
                            id = 18,
                            Name = "Получение данных страницы активности аккаунта"
                        },
                        new
                        {
                            id = 19,
                        ...
                        {
                            id = 21,
                            Name = "Изменение данных пароля"
                        },
                        new
                        {
                            id = 22,
                            Name = "Добавление группы пользователем"
                        },
                        new
                        {
                            id = 23,
                        ...
                        {
                            id = 24,
                            Name = "Удаление группы пользователя"
                        },
                        new
                        {
                            id = 25,
                            Name = "Добавление роли пользователем "
                        },
                        new
                        {
                            id = 26,
                        ...
                        {
                            id = 27,
                            Name = "Удаление роли пользователем "
                        },
                        new
                        {
                            id = 28,
                        ...
                        {
                            id = 30,
                            Name = "Получение данных формы просмотра сообщений"
                        },
                        new
                        {
                            id = 31,
                            Name = "Получение данных формы чтения сообщения"
                        });
                });
            ...
            modelBuilder.Entity("OpenSourceEntitys.Models.EntityConfiguration.EntitySystem.Entitys.ProfileAud", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OpenSourceEntitys.Models.EntityConfiguration.EntitySystem.Entitys.ProfileAud", b =>
                {
                    ...
                    b.HasOne("OpenSourceEntitys.Models.EntityConfiguration.EntitySystem.Entitys.Participant", "Participant")
                        .WithMany("ProfileAud")
