...
namespace OpenSourceEntitys.Models.EntityConfiguration.EntitySystem.SystemStorage.StorageEntityContext.Repositorys
{
    public class RepositoryPol : IRepositoryPol
    {
        ...
        public RepositoryPol(EntitySourceContext EntitySourceContext)
        {
            this.EntitySourceContext = EntitySourceContext;
        }

        public async Task<Pol> Append(Pol entity)
        {
            if (entity == null) throw new ArgumentNullException("Error append: argument null");

            await EntitySourceContext.Pols.AddAsync(entity);
        ...
        public async Task<int> Update(Pol entity)
        {
            ...
            if (search != null)
            {
                EntitySourceContext.Pols.Update(entity);
        ...
        public async Task<int> Deleate(Pol entity)
        {
            if (entity == null) throw new ArgumentNullException("Error deleate: argument null");
            ...
            if (search != null)
            {
                EntitySourceContext.Pols.Remove(entity);
        ...
        public async Task<Pol> GetEntity(Pol entity)
        {
            if (entity == null) throw new ArgumentNullException("Error deleate: argument null");

            var search = await EntitySourceContext.Pols.FindAsync(entity);
        ...
        {
            return await EntitySourceContext.Pols.ToListAsync();
        }
    }
}
